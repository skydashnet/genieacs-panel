...
router.post('/:id/update-wan', authenticateToken, DeviceController.updateWanConfig);
router.post('/:id/update-credentials', authenticateToken, DeviceController.updateCredentials);
